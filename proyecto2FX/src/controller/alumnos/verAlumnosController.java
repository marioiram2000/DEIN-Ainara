...
/*
	private boolean filter(Alumno alumno) {
		if (alumno.getDni().toLowerCase().contains(filter.getText().toLowerCase())) {
			if (alumno.getNombre().toLowerCase().contains(filter1.getText().toLowerCase())) {
				if (alumno.getApellido1().toLowerCase().contains(filter2.getText().toLowerCase())
		...
		if (filter.getText().equals("")) {
			if (alumno.getNombre().toLowerCase().contains(filter1.getText().toLowerCase())) {
				if (alumno.getApellido1().toLowerCase().contains(filter2.getText().toLowerCase())) {
					if (alumno.getApellido2().toLowerCase().contains(filter2.getText().toLowerCase())) {
						return true;
					}
				}
			}
